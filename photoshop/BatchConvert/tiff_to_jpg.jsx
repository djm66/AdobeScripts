...
// v1.0
// By Derek Morton
// Convert all .tif files in a folder to .jpg

// A list of file extensions to convert, keep them lower case, script will convert any files
// in upper case automatically. Add file types here if required.
filestoparse = Array("tif", "tiff");
...
function ModifyImage(oFile)
{
    ...
    var nName = oFile.fullName.replace("." + GetFileExtension(oFile), ".jpg");
...
{
    extension = GetFileExtension(inFileName);
    if (extension == "")
    {
        return false;
    }
